...
class TestBorehole(unittest.TestCase):
    def test_init_single_u_uhf(self):
        bh = Borehole()
        fluid = get_fluid("PROPYLENEGLYCOL", fluid_concentration=0.2)
        ...
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.5), 0.20425, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.07984, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.006449, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.086336, delta=0.0001)
    ...
    def test_init_single_u_ubwt(self):
        ...
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.5), 0.20414, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.07984, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.006449, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.086336, delta=0.0001)
    ...
    def test_init_single_u_from_dict(self):
        ...
        self.assertAlmostEqual(bh_2.calc_bh_resist(mass_flow_rate=0.5), 0.20414, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.07984, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.006449, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.086336, delta=0.0001)
    ...
    def test_init_double_u_uhf(self):
        ...
        # only pass flow rate, so pipe resistance should be computed in the process of this call
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.4154), 0.1090, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.045761, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.003270, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.049032, delta=0.0001)
    ...
    def test_init_double_u_ubwt(self):
        ...
        # only pass flow rate, so pipe resistance should be computed in the process of this call
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.4154), 0.1065, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.045761, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.003270, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.049032, delta=0.0001)
    ...
    def test_init_coaxial_uhf(self):
        ...
        # only pass flow rate, so pipe resistance should be computed in the process of this call
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.5), 0.18048, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.082102, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.003046, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.085148, delta=0.0001)
    ...
    def test_init_coaxial_ubwt(self):
        ...
        # only pass flow rate, so pipe resistance should be computed in the process of this call
        self.assertAlmostEqual(bh.calc_bh_resist(mass_flow_rate=0.5), 0.18365, delta=0.0001)
        self.assertAlmostEqual(bh.calc_pipe_cond_resist(), 0.082102, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_resist(mass_flow_rate=0.5), 0.003046, delta=0.0001)
        self.assertAlmostEqual(bh.calc_fluid_pipe_resist(mass_flow_rate=0.5), 0.085148, delta=0.0001)
